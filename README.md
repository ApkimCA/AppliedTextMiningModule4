...
2. Clean, tokenize, and build your feature dictionary for a tweet.
3. Use the classifier from Part 1 to estimate the party of the tweeter.
4. Compare this estimate to their actual party.
